...
elseif has("gui_running") || (&t_Co == 256 && (&term ==# "xterm" || &term =~# "^screen") && exists("g:CSApprox_konsole") && g:CSApprox_konsole) || &term =~? "^konsole"
    CSAHi Normal term=NONE cterm=NONE ctermbg=23 ctermfg=231 gui=NONE guibg=#103040 guifg=#ffffff
    ...
    CSAHi SpecialKey term=bold cterm=NONE ctermbg=23 ctermfg=246 gui=NONE guibg=#103040 guifg=#949494
    CSAHi NonText term=bold cterm=NONE ctermbg=23 ctermfg=246 gui=NONE guibg=#103040 guifg=#949494
    ...
    CSAHi IncSearch term=reverse cterm=NONE ctermbg=231 ctermfg=23 gui=reverse guibg=bg guifg=fg
    ...
    CSAHi VisualNOS term=bold,underline cterm=bold,underline ctermbg=23 ctermfg=231 gui=bold,underline guibg=bg guifg=fg
    ...
    CSAHi Comment term=bold cterm=NONE ctermbg=bg ctermfg=250 gui=NONE guibg=bg guifg=Gray
    ...
    CSAHi Type term=underline cterm=NONE ctermbg=bg ctermfg=115 gui=NONE guibg=bg guifg=#5fd7af
    ...
    CSAHi DiffText term=reverse cterm=bold ctermbg=23 ctermfg=231 gui=bold guibg=bg guifg=fg
...
elseif has("gui_running") || (&t_Co == 256 && (&term ==# "xterm" || &term =~# "^screen") && exists("g:CSApprox_eterm") && g:CSApprox_eterm) || &term =~? "^eterm"
    CSAHi Normal term=NONE cterm=NONE ctermbg=24 ctermfg=255 gui=NONE guibg=#103040 guifg=#ffffff
    ...
    CSAHi SpecialKey term=bold cterm=NONE ctermbg=24 ctermfg=246 gui=NONE guibg=#103040 guifg=#949494
    CSAHi NonText term=bold cterm=NONE ctermbg=24 ctermfg=246 gui=NONE guibg=#103040 guifg=#949494
    ...
    CSAHi IncSearch term=reverse cterm=NONE ctermbg=255 ctermfg=24 gui=reverse guibg=bg guifg=fg
    ...
    CSAHi TabLineSel term=bold cterm=bold ctermbg=bg ctermfg=fg gui=bold guibg=bg guifg=fg
    CSAHi TabLineFill term=reverse cterm=NONE ctermbg=255 ctermfg=24 gui=reverse guibg=bg guifg=fg
    CSAHi CursorColumn term=reverse cterm=NONE ctermbg=24 ctermfg=fg gui=NONE guibg=#003853 guifg=fg
    CSAHi CursorLine term=underline cterm=NONE ctermbg=24 ctermfg=fg gui=NONE guibg=#003853 guifg=fg
    ...
    CSAHi VisualNOS term=bold,underline cterm=bold,underline ctermbg=24 ctermfg=255 gui=bold,underline guibg=bg guifg=fg
    ...
    CSAHi lCursor term=NONE cterm=NONE ctermbg=255 ctermfg=24 gui=NONE guibg=fg guifg=bg
    CSAHi MatchParen term=reverse cterm=NONE ctermbg=51 ctermfg=fg gui=NONE guibg=Cyan guifg=fg
    CSAHi Comment term=bold cterm=NONE ctermbg=bg ctermfg=250 gui=NONE guibg=bg guifg=Gray
    ...
    CSAHi Type term=underline cterm=NONE ctermbg=bg ctermfg=122 gui=NONE guibg=bg guifg=#5fd7af
    ...
    CSAHi DiffAdd term=bold cterm=NONE ctermbg=37 ctermfg=255 gui=NONE guibg=DarkCyan guifg=fg
    CSAHi DiffChange term=bold cterm=NONE ctermbg=34 ctermfg=255 gui=NONE guibg=Green4 guifg=fg
    CSAHi DiffDelete term=bold cterm=NONE ctermbg=16 ctermfg=255 gui=NONE guibg=black guifg=fg
    CSAHi DiffText term=reverse cterm=bold ctermbg=24 ctermfg=255 gui=bold guibg=bg guifg=fg
    CSAHi SignColumn term=NONE cterm=NONE ctermbg=250 ctermfg=19 gui=NONE guibg=Grey guifg=DarkBlue
    CSAHi SpellBad term=reverse cterm=undercurl ctermbg=bg ctermfg=196 gui=undercurl guibg=bg guifg=fg guisp=Red
    CSAHi SpellCap term=reverse cterm=undercurl ctermbg=bg ctermfg=226 gui=undercurl guibg=bg guifg=fg guisp=Yellow
...
elseif has("gui_running") || &t_Co == 256
    ...
    CSAHi Type term=underline cterm=NONE ctermbg=bg ctermfg=79 gui=NONE guibg=bg guifg=#5fd7af
...
elseif has("gui_running") || &t_Co == 88
    CSAHi Normal term=NONE cterm=NONE ctermbg=16 ctermfg=79 gui=NONE guibg=#103040 guifg=#ffffff
    ...
    CSAHi SpecialKey term=bold cterm=NONE ctermbg=16 ctermfg=83 gui=NONE guibg=#103040 guifg=#949494
    CSAHi NonText term=bold cterm=NONE ctermbg=16 ctermfg=83 gui=NONE guibg=#103040 guifg=#949494
    ...
    CSAHi VisualNOS term=bold,underline cterm=bold,underline ctermbg=16 ctermfg=79 gui=bold,underline guibg=bg guifg=fg
    ...
    CSAHi Comment term=bold cterm=NONE ctermbg=bg ctermfg=85 gui=NONE guibg=bg guifg=Gray
    ...
    CSAHi Type term=underline cterm=NONE ctermbg=bg ctermfg=42 gui=NONE guibg=bg guifg=#5fd7af
    ...
    CSAHi DiffAdd term=bold cterm=NONE ctermbg=21 ctermfg=79 gui=NONE guibg=DarkCyan guifg=fg
    CSAHi DiffChange term=bold cterm=NONE ctermbg=20 ctermfg=79 gui=NONE guibg=Green4 guifg=fg
    CSAHi DiffDelete term=bold cterm=NONE ctermbg=16 ctermfg=79 gui=NONE guibg=black guifg=fg
    CSAHi DiffText term=reverse cterm=bold ctermbg=16 ctermfg=79 gui=bold guibg=bg guifg=fg
